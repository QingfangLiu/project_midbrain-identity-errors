...
name1 = fullfile(parentDir,'ROIs','TargetRegion_lLPFC.nii');
name2 = fullfile(parentDir,'ROIs','TargetRegion_rLPFC.nii');
name3 = fullfile(parentDir,'ROIs','SPEEDTMS_group_mask.nii');
  
newname = 'TargetRegion_LPFC_bilateral.nii'; % define new name for the conjunctive mask
